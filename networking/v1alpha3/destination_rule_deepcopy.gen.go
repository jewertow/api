...
// DeepCopyInto supports using TrafficPolicy_TunnelSetting within kubernetes types, where deepcopy-gen is used.
func (in *TrafficPolicy_TunnelSetting) DeepCopyInto(out *TrafficPolicy_TunnelSetting) {
	p := proto.Clone(in).(*TrafficPolicy_TunnelSetting)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrafficPolicy_TunnelSetting. Required by controller-gen.
func (in *TrafficPolicy_TunnelSetting) DeepCopy() *TrafficPolicy_TunnelSetting {
	if in == nil {
		return nil
	}
	out := new(TrafficPolicy_TunnelSetting)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new TrafficPolicy_TunnelSetting. Required by controller-gen.
func (in *TrafficPolicy_TunnelSetting) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
