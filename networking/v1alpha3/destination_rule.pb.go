...
type TrafficPolicy struct {
	...
	Tunnel *TrafficPolicy_TunnelSetting `protobuf:"bytes,6,opt,name=tunnel,proto3" json:"tunnel,omitempty"`
}
...
func (x *TrafficPolicy) GetTunnel() *TrafficPolicy_TunnelSetting {
	if x != nil {
		return x.Tunnel
	}
	return nil
...
type TrafficPolicy_TunnelSetting struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TrafficPolicy_TunnelSetting) Reset() {
	*x = TrafficPolicy_TunnelSetting{}
	if protoimpl.UnsafeEnabled {
...
func (x *TrafficPolicy_TunnelSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrafficPolicy_TunnelSetting) ProtoMessage() {}

func (x *TrafficPolicy_TunnelSetting) ProtoReflect() protoreflect.Message {
	mi := &file_networking_v1alpha3_destination_rule_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrafficPolicy_TunnelSetting.ProtoReflect.Descriptor instead.
func (*TrafficPolicy_TunnelSetting) Descriptor() ([]byte, []int) {
	return file_networking_v1alpha3_destination_rule_proto_rawDescGZIP(), []int{1, 1}
}

func (x *TrafficPolicy_TunnelSetting) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
func (x *TrafficPolicy_TunnelSetting) GetDestinationPort() uint32 {
	if x != nil {
...
var file_networking_v1alpha3_destination_rule_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x61, 0x64, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x9a, 0x08, 0x0a,
	...
	0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x4e, 0x0a, 0x06, 0x74, 0x75, 0x6e, 0x6e, 0x65, 0x6c,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x69, 0x73, 0x74, 0x69, 0x6f, 0x2e, 0x6e,
	0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68,
	0x61, 0x33, 0x2e, 0x54, 0x72, 0x61, 0x66, 0x66, 0x69, 0x63, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	0x2e, 0x54, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x06,
	...
	0x52, 0x03, 0x74, 0x6c, 0x73, 0x1a, 0x62, 0x0a, 0x0d, 0x54, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x53,
	0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x20, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63,
	0x6f, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x04, 0xe2, 0x41, 0x01, 0x02, 0x52, 0x08,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x12, 0x2f, 0x0a, 0x10, 0x64, 0x65, 0x73, 0x74,
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0d, 0x42, 0x04, 0xe2, 0x41, 0x01, 0x02, 0x52, 0x0f, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x22, 0xf5, 0x01, 0x0a, 0x06, 0x53, 0x75,
...
var file_networking_v1alpha3_destination_rule_proto_goTypes = []interface{}{
	...
	(*TrafficPolicy_TunnelSetting)(nil),                      // 12: istio.networking.v1alpha3.TrafficPolicy.TunnelSetting
...
var file_networking_v1alpha3_destination_rule_proto_depIdxs = []int32{
	...
	12, // 8: istio.networking.v1alpha3.TrafficPolicy.tunnel:type_name -> istio.networking.v1alpha3.TrafficPolicy.TunnelSetting
...
func file_networking_v1alpha3_destination_rule_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_networking_v1alpha3_destination_rule_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TrafficPolicy_TunnelSetting); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
