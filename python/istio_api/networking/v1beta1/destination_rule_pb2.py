...
_TRAFFICPOLICY_TUNNELINGSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='destination_port', full_name='istio.networking.v1beta1.TrafficPolicy.TunnelingSettings.destination_port', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='use_post', full_name='istio.networking.v1beta1.TrafficPolicy.TunnelingSettings.use_post', index=1,
